...
#
# - No refactoring yet
# - Add tests to enable refactoring
# - These tests are so-called characterization tests
# - They are not particularly nice, but they allow us to refactor the code with
#   confidence
# - However, there is a better way to test the system in this case: see invoice_v2.py
