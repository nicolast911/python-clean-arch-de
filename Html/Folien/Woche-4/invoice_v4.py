# invoice_v4.py:
#
# - Reverted back to invoice_v2.py
# - Refactoring to prepare for extracting the function that processes a single line
#   - Introduce `DepartmentStatistics` class
#   - Destructure `line_item` in the for loop body
#   - Turn `result` into a `StringIO` object
